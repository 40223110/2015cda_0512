...
class Hello(object):
    ...
    <form method=\"post\" action=\"gear3\">
        <fieldset>
        <legend>40223110的7顆齒輪嚙合參數表單(會畫圖):</legend>
        齒數1:<br />
    ...
    def drawspuraction(self, m=None, ng1=None,inp2=None):
        outString = ""
        outString +="紅色，40223110常浩繪製<br />齒數:"+ng1
        outString += "<br />"
        outString +="模數:"+m
        outString += "<br />"
        outString +="壓力角:"+inp2
    ...
    def spuraction(self, m=None, ng1=None,inp2=None):
        ...
        outString += self.menuLink()
        return outString
    #@+node:2015.20150512113138.1: *3* gear3
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def gear3(self, m=None, ng1=None, ng2=None, ng3=None, ng4=None, ng5=None, ng6=None, ng7=None, inp2=None):
        outString = ""
